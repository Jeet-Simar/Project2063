...
public class MyAdapter_audio extends RecyclerView.Adapter<MyAdapter_audio.ViewHolder> {
    ...
    private final List<AudioInfo> dataset;
    private final AppCompatActivity parentActivity;
    private final SharedPreferences sharedPreferences;

    public MyAdapter_audio(AppCompatActivity parentActivity, List<AudioInfo> myDataset, SharedPreferences sharedPreferences) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final AudioInfo item = dataset.get(position);
