...
public class JsonUtils_video {
    ...
    private ArrayList<VideoInfo> hostCitiesArray;

    // Initializer to read our data source (JSON file) into an array of host city objects
    public JsonUtils_video(Context context) {
        processJSON(context);
    }
    ...
    private void processJSON(Context context) {
        ...
        try {
            ...
            for (int i=0; i < jsonArray.length(); i++) {
                ...
                VideoInfo city = new VideoInfo.Builder(elementObject.getString(KEY_YEAR),
    ...
    public ArrayList<VideoInfo> getHostCities() {
